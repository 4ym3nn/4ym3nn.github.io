...
{
    // Complex function that builds expressions and evaluates them
    // [Truncated for brevity - the full disassembly is quite long]
}
```
...
```c
uint64_t Mod1::findC13Lines(int64_t arg1)
{
    // Complex function with multiple RC4 decryption stages
